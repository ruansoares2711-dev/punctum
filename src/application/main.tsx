/**
 * Application bootstrap (camada `application` / main).
 *
 * Centraliza a inicialização do roteador. Server-side e client-side entries
 * do TanStack Start consomem `getRouter` daqui.
 */
